...
(function (window) {
  ...
  function api(path, opts) {
    return fetch(AUTH_API + path, Object.assign({ credentials: 'same-origin' }, opts || {}));
  }
  ...
  window.Auth = { me: me, providers: providers, logout: logout, updateAuthUI: updateAuthUI, get user() { return currentUser; } };
})(window);
